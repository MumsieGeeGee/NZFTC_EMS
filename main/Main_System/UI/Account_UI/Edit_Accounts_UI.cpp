...
void Display_Account_Details_Block(const std::map<std::string, std::string>& account_details) {
    ...
    std::cout << Business_Department_Label << ": " << Get_Account_Detail_Value(account_details, "Business Department") << std::endl;
...
void Display_Selected_User_Edit_Options_Menu_UI() {
    ...
    std::cout << "12. " << Return_to_Account_Management_Main_Menu_Label << std::endl;
}

void Display_Selected_User_Edit_Options_Input_Prompt_UI() {
	std::cout << "Please select an edit option (1-12): ";
}
