    ...
    : QWidget(parent)
{
    ...
    const QString textColor = "white";
        ...
        QFont buttonFont("Lucida Sans", 20, QFont::Bold);
        logout->setFont(buttonFont);
        logout->setStyleSheet(QString("QPushButton { background:%1; color:%2; border:none; padding:10px 20px; font-size:14px; border-radius:4px; } QPushButton:hover { background:%3; }")
                             .arg(buttonBg).arg(textColor).arg(buttonHover));
        logout->setFixedSize(120, 42);
