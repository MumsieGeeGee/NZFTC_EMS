...
#include "mainUI.h"
#include "../Shared_UI_Elements/Admin_Dash_Home_Page.h"
#include "../Shared_UI_Elements/Employee_Dash_Home_Page.h"
#include <QLabel>
#include <QWidget>
#include <QVBoxLayout>
#include <QFrame>
...
void setupLoginUI(QMainWindow *window)
{
    ...
    QObject::connect(loginBtn, &QPushButton::clicked, window, [window]() { setupAdminDashboardUI(window); });
